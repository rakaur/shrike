...
E boolean_t is_xop_host(mychan_t *mychan, user_t *user, uint8_t level);
E boolean_t should_op(mychan_t *mychan, user_t *user);
E boolean_t should_op_host(mychan_t *mychan, char *host);
E boolean_t should_voice(mychan_t *mychan, user_t *user);
