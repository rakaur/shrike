...
static void do_set_hold(char *origin, char *name, char *params)
{
  ...
  if (*name == '#')
  {
    ...
    if (!strcasecmp("ON", params))
    {
      ...
      snoop("SET:HOLD:ON for \2%s\2", mc->name);
    ...
    else if (!strcasecmp("OFF", params))
    {
      ...
      snoop("SET:HOLD:OFF for \2%s\2", mc->name);
  ...
  else
  {
    ...
    if (!strcasecmp("ON", params))
    {
      ...
      snoop("SET:HOLD:ON for \2%s\2", mu->name);
    ...
    else if (!strcasecmp("OFF", params))
    {
      ...
      snoop("SET:HOLD:OFF for \2%s\2", mu->name);
  ...
  *end = 0;
  ...
  if (*modebuf)
  {
    notice(origin, "The MLOCK for \2%s\2 has been set to \2%s\2.",
           mc->name, modebuf);
    snoop("SET:MLOCK: \2%s\2 to \2%s\2", mc->name, modebuf);
  }
  else
  {
    notice(origin, "The MLOCK for \2%s\2 has been removed.", mc->name);
    snoop("SET:MLOCK:OFF: \2%s\2", mc->name);
  }
...
static void do_set_neverop(char *origin, char *name, char *params)
{
  ...
  if (*name == '#')
  {
    ...
    if (!strcasecmp("ON", params))
    {
      ...
      snoop("SET:NEVEROP:ON for \2%s\2", mc->name);
    ...
    else if (!strcasecmp("OFF", params))
    {
      ...
      snoop("SET:NEVEROP:OFF for \2%s\2", mc->name);
  ...
  else
  {
    ...
    if (!strcasecmp("ON", params))
    {
      ...
      snoop("SET:NEVEROP:ON for \2%s\2", mu->name);
    ...
    else if (!strcasecmp("OFF", params))
    {
      ...
      snoop("SET:NEVEROP:OFF for \2%s\2", mu->name);
...
static void do_set_secure(char *origin, char *name, char *params)
{
  ...
  if (!strcasecmp("ON", params))
  {
    ...
    snoop("SET:SECURE:ON for \2%s\2", mc->name);
  ...
  else if (!strcasecmp("OFF", params))
  {
    ...
    snoop("SET:SECURE:OFF for \2%s\2", mc->name);
